...
├── open-science.qmd         # Open science + datasets
├── blog/                    # Blog posts
├── data/                    # YAML data files (CV, publications, site)
├── scripts/                 # Python generators for includes
├── _includes/               # Autogenerated includes (from data/)
├── assets/
