...
- **ICE³ Project**: Modelling the global multi-century evolution of glacier ice in 3D (VUB)
...
- Open-source development for the Open Global Glacier Model (OGGM)

## Affiliations

- **Vrije Universiteit Brussel** — Department of Water and Climate, HYDR group
- **bglacier** — Glaciology research group at VUB
- **Universidad de Concepción** — Collaborating researcher
- **OGGM** — Open Global Glacier Model community member
