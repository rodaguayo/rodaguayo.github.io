...
SVG_PATHS = {
    ...
    "bluesky":  "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z",
    ...
    "scholar":  "M12 2L2 7v1l10 5 10-5V7l-10-5zM2 10v5l10 5 10-5v-5L12 15 2 10z",
    "orcid":    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM7.5 7.5h2v9h-2v-9zm4.5 0h2c1.5 0 2.5.5 3 1.5s.5 2 .5 3.5c0 1.5-.5 2.5-1.5 3.5s-2 1.5-3.5 1.5h-2v-9zm2 7.5c.5 0 .83-.17 1-.5s.33-.83.33-1.5c0-.67-.11-1.17-.33-1.5s-.5-.5-1-.5h-.5v4h.5z",
    "rg":       "M8 3v18h8V3H8zm6 15h-4v-2h4v2zm0-4h-4v-2h4v2zm0-4h-4V8h4v2zm1-6H9V2h6v2z",
}
